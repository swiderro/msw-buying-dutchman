...
//TODO Po zakoñczeniu aukcji poprawiæ odœwie¿anie jPAuctionCommand
//TODO error.txt w katalogu magisterska
//TODO brak historii bidów dla aukcji drugiej ceny, dla holenderskiej. Dla angielskiej i przetargów jest ok.
...
/**
 * Klasa implementuj¹ca i umiejscawiaj¹ca agenta w œrodowisku platformy
 * agentowej. Jej odpowiedzialnoœci¹ s¹:
 * <ol>
...
public class BuyingDutchmanAgent extends GuiAgent {
	...
	/** Obiekt TableModel dla tabeli historii ofert na aukcjach zakoñczonych */
	 ...
	 * zale¿noœci od typu zdarzenia ev.getType()
	 * 
	 * @param ev
	...
	/**
	 * Metoda obs³uguje funkcjonalnoœæ automatycznego licytowania. Dodaje obiekt
	 * typu AutomaticBuyer do zbioru automaticBuyers agenta lokalnego. Metoda
	 * uruchamiana po stronie agenta lokalnego.
	 * 
	 * @param auctionNr
	 *            numer aukcji, która zostanie automatycznie licytowana.
	 * @param auctioneer
	 *            agent, bêd¹cy sprzedawc¹ na danej aukcji.
	 * @param bid
	...
	private String reducePrices() {
		...
		while (i.hasNext()) {
			...
			if (a.isFinished()) {
				...
				// ocenianie ofert nie nale¿y do tej czêœci programu, poni¿sze
				// wyciête z warunku
	...
	private class BDFinishedAuctionsTableModel extends AbstractTableModel {
		...
		// TODO 001 Nie jest wo³ane. Sprawdziæ, co jest zepsute w GUI. Mo¿e
		// viewport?
		@Override
		public int getRowCount() {
	...
	//TODO 001 SPRAWDZIÆ CZY DZIA£A POPRAWNIE
	...
	// TODO MUST historia ofert na zakoñczonych aukcjach
}
